...
public class TokenUtil {
	private static final String TOKEN_SECRET="subhashree";
    // This method create a token with the id parameter as a claim. It then returns the same token.This method called by client side
    ...
    // This method decodes the passed token and returns the id claim. If the verification fails it will throw an exception.This
   // method called by serverside
